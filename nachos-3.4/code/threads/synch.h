...
class Lock {
  ...
  private:
    ...
    bool value;             // lock value is 0/1. so boolean
    List *queue;            // those who are wating to get this lock
    Thread* holderThread;    // thread that have permitter to hold the lock
